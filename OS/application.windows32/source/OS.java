...
public void draw() {
  ...
  if (SystemOn == true) {
    ...
    fill(70);
    text(month+" "+hourValue+":"+minuteValue+" "+dayTime, 1082.25f, 15.25f);
  ...
  fill(255);
  textSize(15);
  text("FPS"+" "+ PApplet.parseInt(frameRate), 10, 36);
}
...
public void halfHorizontalSizeLeft() {
  menuOffsetX = -30;
  menuOffsetY = -8;
...
public void halfHorizontalSizeRight() {
